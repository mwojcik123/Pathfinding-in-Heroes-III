...
bi = b'\xa7\xa7\xa7\xa7\xa7\xa7\xe0\xff\xa1\x1b\xff\x1b\xc7dB\x88\x1c\x0e\x0f\x14%&hy\x94\x8fn`FC'
# print(bytes.decode(bi, encoding="gb18030"))
# byt1 = bytes(string, "cp1250")
# byt2 = bytes(string, "cp1250")

print(arr)
arr.extend(string3)
print(arr)
# print(bytes(string, "cp1250"))
# print(byt1+byt2)
